...
class Base {
	...
	request(params) {
		...
		var baseRestUrl = 'http://gaokao.bj01.bdysite.com/api/public/index.php/api/v1/';
	...
	uploadFile(filePath, name, formData, callback) {
		...
		wx.uploadFile({
			url: 'http://gaokao.bj01.bdysite.com/api/public/index.php/api/v1/Base/FtpFile/upload',
